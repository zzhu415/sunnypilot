...
TorqueFriction::TorqueFriction() : AbstractControl("Torque: Friction", "Adjust TorqueFriction", "../assets/offroad/icon_shell.png") {
...
TorqueMaxLatAccel::TorqueMaxLatAccel() : AbstractControl("Torque: MAX_LAT_ACCEL", "Adjust TorqueMaxLatAccel", "../assets/offroad/icon_shell.png") {
...
TorqueUseSteeringAngle::TorqueUseSteeringAngle() : AbstractControl("Torque: useSteeringAngle",
                                                   "Use Steering Angle in Torque lateral control.",
                                                   "../assets/offroad/icon_metric.png") {
  ...
  QObject::connect(&btnminus, &QPushButton::clicked, [=]() {
    auto str = QString::fromStdString(params.get("TorqueUseSteeringAngle"));
    int value = str.toInt();
    value = value - 1;
    if (value <= 0 ) {
      value = 0;
    ...
    QString values = QString::number(value);
    params.put("TorqueUseSteeringAngle", values.toStdString());
    refresh();
  });
...
void TorqueUseSteeringAngle::refresh() {
  QString option = QString::fromStdString(params.get("TorqueUseSteeringAngle"));
  if (option == "0") {
    label.setText(QString::fromStdString("OFF"));
  } else if (option == "1") {
    label.setText(QString::fromStdString("ON"));
  }
  btnminus.setText("-");
  btnplus.setText("+");
}