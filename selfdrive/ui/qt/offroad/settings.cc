...
SunnypilotPanel::SunnypilotPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggles.append(new ParamControl("CustomLateralTune",
                                  "Torque Lateral Live Tune",
  ...
  if (Params().getBool("CustomLateralTune")) {
    toggle_layout->addWidget(horizontal_line());
    toggle_layout->addWidget(new TorqueFriction());
    toggle_layout->addWidget(horizontal_line());
    toggle_layout->addWidget(new TorqueMaxLatAccel());
    toggle_layout->addWidget(horizontal_line());
    toggle_layout->addWidget(new TorqueUseSteeringAngle());
  }
