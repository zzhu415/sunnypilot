...
def create_acc_commands(packer, enabled, accel, jerk, idx, lead_visible, set_speed, stopping, gas_pressed, main_enabled, escc, cs_escc):
  commands = []
  ...
  scc12_values = {
    ...
    "AEB_CmdAct": escc_values["AEB_CmdAct"] if escc else 0,
    "CF_VSM_Warn": escc_values["CF_VSM_Warn_SCC12"] if escc else 0,
    "CR_VSM_DecCmd": escc_values["CR_VSM_DecCmd_SCC12"] if escc else 0,
    "CF_VSM_DecCmdAct": escc_values["CF_VSM_DecCmdAct_SCC12"] if escc else 0,
  ...
  fca11_values = {
    ...
    "FCA_CmdAct": escc_values["FCA_CmdAct"] if escc else 0,
    "CF_VSM_Warn": escc_values["CF_VSM_Warn_FCA11"] if escc else 0,
    "CF_VSM_DecCmdAct": escc_values["CF_VSM_DecCmdAct_FCA11"] if escc else 0,
    "CR_VSM_DecCmd": escc_values["CR_VSM_DecCmd_FCA11"] if escc else 0,
  }
