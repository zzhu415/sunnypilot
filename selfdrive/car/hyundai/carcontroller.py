...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, pcm_cancel_cmd, visual_alert, hud_speed,
    ...
    if not CS.CP.openpilotLongitudinalControl:
      if self.p.FEATURE_ACC_MAIN_NO_ENGAGE:
        # HYUNDAI SANTA FE 2022 VIET MODEL ONLY
        if CS.car_fingerprint == CAR.SANTA_FE_2022_VIET:
    ...
    if frame % 5 == 0 and self.car_fingerprint in [CAR.SONATA, CAR.PALISADE, CAR.IONIQ, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV_2021,
                                                   ...
                                                   CAR.ELANTRA_2021, CAR.ELANTRA_HEV_2021, CAR.SONATA_HYBRID, CAR.KONA_HEV, CAR.SANTA_FE_2022, CAR.SANTA_FE_2022_VIET,
