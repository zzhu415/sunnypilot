...
class CarController:
  ...
  def update(self, CC, CS):
    ...
    if self.frame % 10 == 0:
      ...
      can_sends.extend(hondacan.create_ui_commands(self.packer, self.CP, CC.enabled and CS.out.cruiseState.enabled, CC.latActive, pcm_speed, hud, CS.is_metric, CS.stock_hud))
