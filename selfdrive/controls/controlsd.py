...
class Controls:
  def __init__(self, sm=None, pm=None, can_sock=None):
    ...
    self.CP.alternativeExperience = 1  # see panda/board/safety_declarations.h for allowed values
  ...
  def state_control(self, CS):
    ...
    CC.latActive = self.active and not CS.steerFaultTemporary and not CS.steerFaultPermanent and \
                     ...
                     (CS.lfaEnabled or CS.accMainEnabled or CS.lkasEnabled) and \
                     ((CS.automaticLaneChange and not CS.belowLaneChangeSpeed) or ((not (((self.sm.frame - self.last_blinker_frame) * DT_CTRL) < 1.0) or not CS.belowLaneChangeSpeed) and \
                     not (CS.leftBlinkerOn or CS.rightBlinkerOn)))
    CC.longActive = self.active and CS.cruiseState.enabled
    ...
    if lac_log.active and lac_log.saturated and not CS.steeringPressed and \
